...
import { RequestWithParams, RequestWithQuery } from '../interfaces/commonTypes.js'

const EventController = {
  getEvents: async (req: RequestWithQuery<{ page: number; limit: number }>, res: Response) => {
  ...
  getParticipants: async (req: RequestWithParams<{eventId: string}>, res: Response) => {
  ...
  addParticipant: async (req: RequestWithParams<{eventId: string}>, res: Response) => {
    const { eventId } = req.params
